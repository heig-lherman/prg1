#ifndef PRG1_D21_L5_FRACTIONS_FRAC2IMPL_H
#define PRG1_D21_L5_FRACTIONS_FRAC2IMPL_H
...
template<typename T>
template<typename U>
void Frac<T>::initValues(const Frac<U> &other) {
    numerator = (T) other.numerator;
    denominator = (T) other.denominator;
...
template<typename T>
template<typename U>
Frac<T> &Frac<T>::operator+=(const Frac<U> &rhs) {
    // x + -y = x - y
...
template<typename T>
template<typename U>
bool Frac<T>::operator==(const Frac<U> &rhs) const {
...
#endif //PRG1_D21_L5_FRACTIONS_FRAC2IMPL_H
